...
<div class="text-center mb-12 -mt-4">
  <p class="text-xl text-gray-600 dark:text-gray-300 mb-2">一份面向未来医学科学家的交互式讲义</p>
  <p class="text-sm font-medium text-indigo-600 dark:text-indigo-400">编撰者：纪家灏 | 复旦大学上海医学院 19级八年制</p>
</div>
