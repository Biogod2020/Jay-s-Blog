#!/usr/bin/env python3
"""Check representative legacy mathematics, diagrams and the isolated WebGL page."""
...
try:
    with sync_playwright() as p:
        ...
        canvas.wait_for(state='visible',timeout=60000)
        ...
        # Raw HTML without heading metadata must stay readable before the TOC fallback runs.
