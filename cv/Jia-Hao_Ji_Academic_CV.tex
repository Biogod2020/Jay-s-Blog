...
\begin{cvitems}
  \cvitem{Built scRNA-seq analysis pipelines to identify markers relevant to the purity, safety, and therapeutic potential of iPSC-derived dopaminergic progenitors.}
\end{cvitems}
...
\begin{cvitems}
  \cvitem{Received foundational wet-lab training in molecular biology, cell culture, DNA methylation, epigenetic regulation, and standard biochemical assays.}
\end{cvitems}
...
\begin{cvitems}
  \cvitem{Fine-tuned vision-language encoders with contrastive objectives to align histopathology image patches with spatial-transcriptomic signals for cross-modal retrieval and tissue representation learning. \href{https://github.com/Biogod2020/Spatial-Clip}{GitHub}}
\end{cvitems}
...
Languages & Mandarin Chinese, Cantonese, and Teochew; English (TOEFL 105); Spanish (basic) \\
\end{tabularx}
