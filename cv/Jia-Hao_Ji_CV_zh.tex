...
\begin{tabularx}{\textwidth}{@{}X>{\RaggedLeft\arraybackslash}p{31mm}@{}}
  \begin{minipage}[t]{\linewidth}
    ...
    \vspace{0.18em}
    {\fontsize{10.8}{12.0}\selectfont\bfseries\color{Navy}八年制医学博士候选人｜人工智能研究者｜医师科学家培养中}\par
    \vspace{0.34em}
    {\fontsize{8.15}{9.55}\selectfont\color{Muted}\RaggedRight
      构建面向生物医学发现的可靠智能体与多模态人工智能系统，当前聚焦空间组学、神经科学与多智能体推理。
    }\par
    \vspace{0.34em}
    {\fontsize{7.45}{8.7}\selectfont\color{Muted}
      ...
      \href{https://jiahaoblog.com/zh/}{jiahaoblog.com/zh} \hspace{0.35em}\textcolor{Rule}{\textbullet}\hspace{0.35em}
  ...
  \begin{minipage}[t]{31mm}
    \vspace{0pt}
    \fcolorbox{Rule}{white}{\includegraphics[width=27.5mm,trim=460 465 460 60,clip]{avatar.jpg}}
  \end{minipage}
\end{tabularx}
...
{将多智能体推理解耦为候选生成、答案识别与终端选择，发现系统常已生成正确答案，却在共识过程中将其丢失。}
...
{构建可追溯证据的智能体工作流，用于恢复、审计并标准化分散的多模态空间组学记录。}
{769 组 H\&E--空间转录组配对数据｜2,920 万个空间点或细胞｜相较既有人工整理基线扩大 6.4 倍}

\pubentry
{时空转录组揭示与阿尔茨海默病胆碱能易损性相关的反应性基底前脑小胶质细胞}
{\textbf{纪家灏}（共同第一作者）等，手稿，2026。}
{整合空间转录组、单核测序与原位淀粉样病理，解析疾病相关小胶质细胞状态及其与胆碱能神经元易损性的关系。}
{1,236 万个空间表达谱}

\sectiontitle{科研经历}

\role{科研项目负责人}{复旦大学数据驱动未来实验室｜医学遗传研究所}{2023.09--至今}
\smallmeta{导师：郁金泰教授、原致远教授｜阿尔茨海默病、空间组学与生物医学人工智能}
\begin{compactitems}
  \item 负责大规模空间数据整理、多模态组织配准以及组织学与分子表达联合分析等计算研究。
  \item 开发基于 Transformer 与图像配准的方法，对齐全切片病理图像和空间转录组坐标；建立具备显式模式约束、证据追踪与多阶段验证的智能体流程。
  \item 通过固定候选池回放实验系统研究大模型评审可靠性与终端答案选择机制。
\end{compactitems}
...
\vspace{0.08em}
\role{本科科研成员}{复旦大学生命科学相关研究平台｜兰斐教授课题组}{2019.09--2021.07}
\begin{compactitems}
  \item 接受分子生物学、细胞培养、DNA 甲基化、表观遗传调控及基础生化实验训练。
\end{compactitems}

\sectiontitle{代表性系统}
\bodytext{\textbf{ASSA}：面向长程任务的模块化智能体框架，包含分层记忆、反思与技能生成机制（\href{https://github.com/Biogod2020/ASSA}{GitHub}）。\quad \textbf{Spatial-CLIP}：使用对比学习对齐组织病理图像与空间转录组状态（\href{https://github.com/Biogod2020/Spatial-Clip}{GitHub}）。}
...
\sideheading{研究方向}
\skillline{科学智能体}{面向科研数据与工作流的证据驱动自主系统。}
\skillline{多模态生物医学 AI}{空间组学、数字病理、组织配准与神经系统疾病。}
\skillline{可靠多智能体推理}{候选生成、评审可靠性、通信与答案选择。}
...
\sideheading{教学与荣誉}
\bodytext{受邀面向复旦大学本科生与研究生讲授 AI 原生科研工作流，涵盖文献综合、科研写作与可复现研究，2025。}\par
\vspace{0.28em}
